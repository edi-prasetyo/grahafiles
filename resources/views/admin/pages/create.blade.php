...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-md-9 mx-auto">
            ...
            <form action="{{ url('pages/store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-primary my-3">Publish Page</button>
                    </div>
                </div>
